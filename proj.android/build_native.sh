# set params
NDK_ROOT=/cygdrive/c/android_proj/android-ndk-r8b-windows/android-ndk-r8b
COCOS2DX_ROOT=/cygdrive/c/android_proj/cocos2d-2.0-rc2-x-2.0.1
GAME_ROOT=$COCOS2DX_ROOT/whackyourboss
